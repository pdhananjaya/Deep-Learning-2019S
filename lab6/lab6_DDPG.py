...
def evaluation(
    ...
    avg = np.sum(scores) + 700
    return avg/eval_size
...
get_ipython().run_cell_magic('time', '', "#train(agent, 3500, 64)\nagent = loadAgent('agent-DDPG.pkl')")
